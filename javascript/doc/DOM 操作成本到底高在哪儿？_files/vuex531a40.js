...
function i(e){
M.setSum(221764,S.isIOS?e:e+1,1),M.send();
}
function a(e){
...
success:function(o){
try{
I[n]=JSON.parse(o),console.info("[Lifecycle Manager] Preload PageData",n,e,I[n]),
...
I[n]&&I[n].video_page_info&&"string"==typeof I[n].video_page_info.cover_url&&((new Image).src=I[n].video_page_info.cover_url);
}
});
}
function d(e,n){
if(!G){
if(G=!0,console.info("[Lifecycle Manager] Start to switch to",e),w.info("[Lifecycle Manager] Start to switch to",e),
P.add19735ExtData({
EventType:3
}),L.reportNow(),!E)return void y.loadNewPageKeepingHistoryStackIfSecOpen(e);
var o=_extends({},j.getParams(location.href),j.getParams(e)),a=3e3,t=2,r=0,g=null;
s();
var u=function(){
if(r===t)if(g&&g.base_resp&&0===g.base_resp.ret){
I={};
var n=j.getParams(location.href);
f(g,n),c(),G=!1,i(30),console.info("[Lifecycle Manager] Finish to switch to",e),
...
document.removeEventListener("WeixinJSBridgeAuthChanged",k),console.info("[Lifecycle Manager] GetA8Key Success",n.state),
w.info("[Lifecycle Manager] GetA8Key Success",n.state),history.replaceState(null,"",n.fullUrl),
clearTimeout(d),S.isIOS&&(window.__second_open__=D),p(e),r++,u();
};
document.addEventListener("WeixinJSBridgeAuthChanged",h),history.replaceState(null,"",e);
var v=function M(){
S.isAndroid&&document.removeEventListener("WeixinJSBridgeSpaHistoryChanged",M),console.info("[Lifecycle Manager] History Stack Changed"),
w.info("[Lifecycle Manager] History Stack Changed"),S.isIOS&&(D=window.__second_open__),
...
w.error("[Lifecycle Manager] Invoke GetA8Key Failed",JSON.stringify(n)),clearTimeout(d),
y.loadNewPageKeepingHistoryStackIfSecOpen(e));
});
};
S.isAndroid?document.addEventListener("WeixinJSBridgeSpaHistoryChanged",v):v(),n&&I[n]?(console.info("[Lifecycle Manager] Get Cache PageData",n),
w.info("[Lifecycle Manager] Get Cache PageData",n),g=I[n],f(g,o),l(g),r++,u()):_({
url:e.replace(/#.*$/,"")+"&action=preload",
type:"GET",
async:!1,
timeout:2e3,
...
var w=e("biz_wap/jsapi/log.js"),_=e("biz_wap/utils/ajax.js"),y=e("common/utils.js"),m=e("biz_wap/jsapi/core.js"),h=e("biz_wap/utils/device.js"),v=e("biz_common/utils/url/parse.js"),k=e("biz_common/utils/cookie.js"),S=e("biz_wap/utils/mmversion.js"),j=e("pages_new/modules/utils/url.js"),L=e("biz_wap/jsapi/leaveReport.js"),M=e("biz_wap/utils/jsmonitor_report.js"),P=e("pages_new/common_share/video/report.js"),b=[],C=[],O=[],z=window.top===window&&S.isWechat&&!S.isInMiniProgram&&!window.is_teenager&&(h.os.iphone&&S.gtVersion("8.0.3",1)||h.os.android&&S.gtVersion("8.0.1",1)),E=!1,G=!1,I={},D=void 0;
return z&&S.isIOS&&(console.info("[Lifecycle Manager] Overwrite sys:auth"),w.info("[Lifecycle Manager] Overwrite sys:auth"),
